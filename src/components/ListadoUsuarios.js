...
const MensajeVacio = () => (
  <Typography variant="body1">Nada por aquí...</Typography>
);

export const ListadoUsuariosDesconectado = ({ usuarios }) => {
...
ListadoUsuariosDesconectado.propTypes = {
...
export default function ListadoUsuarios() {
  ...
  return <ListadoUsuariosDesconectado usuarios={usuarios} />;
}
